...
public class TKLoaiToaPanel extends BasePanel {
    ...
    protected void initComponents() {
        ...
        panelForm.add(createInputField("Loại Toa", fieldTuKhoa, Color.WHITE));
        ...
        TitledBorder tableBorder = new TitledBorder(new LineBorder(Color.LIGHT_GRAY), "Danh sách loại toa",
