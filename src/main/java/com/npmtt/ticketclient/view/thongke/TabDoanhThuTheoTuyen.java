...
public class TabDoanhThuTheoTuyen extends BaseThongKeTab<DoanhThuTheoTuyenDTO> {
    ...
    private List<DoanhThuTheoTuyenDTO> listData;

    public TabDoanhThuTheoTuyen() {
        super();
    }
    ...
    @Override
    protected Object[] getRowData(int stt, DoanhThuTheoTuyenDTO item) {
        return new Object[]{
                stt,
                item.getTenTuyen(),
    ...
    @Override
    protected String getTextTongKet(List<DoanhThuTheoTuyenDTO> listData) {
        double doanhThu = 0;
    ...
    public void setData(JFreeChart chart, List<DoanhThuTheoTuyenDTO> listData) {
        this.chart = chart;
